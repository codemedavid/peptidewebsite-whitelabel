...
export const THEME_SEEDS: ThemeSeed[] = [
  ...
  {
    id: "imperial-cinnabar", name: "Imperial Cinnabar", category: "luxury", mode: "light",
    tagline: "Rice-paper beige, imperial red, and gilt.",
    headingFont: "Cormorant Garamond", bodyFont: "Spectral", radius: "0.25rem",
    primary: "#B01E28", primaryForeground: "#FFF8EC",
    accent: "#9E1B24", accentForeground: "#FFF8EC",
    background: "#F7EFDF", surface: "#FFFDF6", subtle: "#F0E6D0",
    text: "#2A1B12", mutedText: "#6E5A46", border: "#DBC9A6",
    success: "#2E7D52", warning: "#8A5E0E", info: "#3A5F86", error: "#A81E2B",
    gradientFrom: "#C8102E", gradientTo: "#D4AF37",
  },
  {
    id: "dynasty-red", name: "Dynasty Red", category: "luxury", mode: "light",
    tagline: "Warm parchment and deep dynasty crimson, gilt-edged.",
    headingFont: "Fraunces", bodyFont: "Spectral", radius: "0.125rem",
    primary: "#9E1B22", primaryForeground: "#FBF3E4",
    accent: "#8C1A1F", accentForeground: "#FBF3E4",
    background: "#F4EAD6", surface: "#FDF6E7", subtle: "#EBDCC0",
    text: "#271711", mutedText: "#68513C", border: "#D6C09B",
    success: "#2C7A50", warning: "#875A0C", info: "#385A80", error: "#9E1B22",
    gradientFrom: "#B01E28", gradientTo: "#C8A24A",
  },
  {
    id: "red-lantern", name: "Red Lantern", category: "luxury", mode: "light",
    tagline: "Festive lantern red on warm beige, glowing gold.",
    headingFont: "Cormorant Garamond", bodyFont: "Outfit", radius: "0.5rem",
    primary: "#C21E2C", primaryForeground: "#FFF6EA",
    accent: "#A81C24", accentForeground: "#FFF6EA",
    background: "#FAF1E0", surface: "#FFFDF7", subtle: "#F5E7CE",
    text: "#2C1A12", mutedText: "#71583F", border: "#E0CCA4",
    success: "#2E7D52", warning: "#8A5E0E", info: "#3A5F86", error: "#B01E28",
    gradientFrom: "#D62828", gradientTo: "#E0B84C",
  },
  // ── Modern SaaS ──
  {
