...
// ── HSL <-> HEX + contrast ──
// The color math lives in ./color so both this role layer and presets.ts
// (the buildTheme factory) can share it without an import cycle. Re-exported
// here so existing `@/lib/theme/tokens` import sites keep resolving these.
export { hexToHslTriple, hslTripleToHex, contrastRatio, luminance, bestForeground } from "./color";
